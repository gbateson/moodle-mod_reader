...
/**
 * mod/reader/admin/quizzes/add_form.php
 *
 * @package    mod
 * @subpackage reader
...
/**
 * mod_reader_admin_quizzes_add_form
 *
 * @copyright  2013 Gordon Bateson (gordon.bateson@gmail.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      Moodle 2.0
 ...
 * @subpackage reader
 */
class mod_reader_admin_quizzes_add_form extends moodleform {
     ...
     */
    function mod_reader_admin_quizzes_add_form($action=null) {
    ...
    function definition() {
        ...
        $this->add_action_buttons(false, get_string('add', 'reader'));
    }
}
