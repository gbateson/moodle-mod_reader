...
require_once($CFG->dirroot.'/mod/reader/admin/reports/groupsummary/tablelib.php');
require_once($CFG->dirroot.'/mod/reader/admin/reports/groupsummary/filtering.php');

/**
 * mod_reader_admin_reports_groupsummary_renderer
 *
 * @copyright  2013 Gordon Bateson (gordon.bateson@gmail.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      Moodle 2.0
