...
class attempt_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_attempt_submitted', 'mod_reader');
    }
    ...
    public function get_description() {
        return get_string('event_attempt_submitted_desc', 'mod_reader', $this);
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'reader', 'OLD_attempt_submitted', 'view.php?id='.$this->objectid, $this->other['readerid'], $this->contextinstanceid);
    }
