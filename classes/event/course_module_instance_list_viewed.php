...
class course_module_instance_list_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_course_module_instance_list_viewed', 'mod_reader');
    }
    ...
    public function get_description() {
        return get_string('event_course_module_instance_list_viewed_desc', 'mod_reader', $this);
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'reader', 'OLD_course_module_instance_list_viewed', 'view.php?id='.$this->objectid, $this->other['readerid'], $this->contextinstanceid);
    }
