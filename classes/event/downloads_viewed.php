...
/**
 * The downloads_viewed event class.
 *
 * @package    mod_reader
 * @copyright  2014 Gordon Bateson (gordon.bateson@gmail.com)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since      Moodle 2.6
 */
class downloads_viewed extends \core\event\base {
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'reader', 'OLD_downloads_viewed', 'view.php?id='.$this->objectid, $this->other['readerid'], $this->contextinstanceid);
    }
