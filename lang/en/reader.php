...
$string['readonlyfromuserdate'] = 'This activity has been in read-only mode since {$a}.';
$string['readonlyuntiluserdate'] = 'This activity will stay in read-only mode until {$a}.';
