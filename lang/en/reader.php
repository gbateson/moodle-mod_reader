...
$string['cheated_message'] = '"Cheated" notice';
$string['checkbox'] = 'Use checkboxes in student report';
$string['computers'] = 'On adjoining computers';
$string['fullpointreport'] = 'Show exact score';
$string['ignor_1'] = 'Ignore quizzes taken before';
$string['ignor_2'] = 'but prevent students from retaking them';
$string['individualstrictip'] = 'Restrict access for individual users';
$string['levelrestrictionfeature'] = 'Use the quiz taking level restriction feature';
$string['nextlevel'] = 'Give next level, when student answered more than correct quizzes';
$string['nopromotion'] = 'No promotion after level';
$string['not_cheated_message'] = 'Points restored notice';
$string['off'] = 'Off';
$string['percentcorrectforbook'] = 'Percent correct for marking the book as read';
$string['questionmark'] = 'Hide individual question values';
...
$string['securitymeasures'] = 'Security measures';
...
$string['selectquizzes'] = 'Allow to select quizzes of previous level';
$string['sendmessagesaboutcheating'] = 'Send messages about cheating?';
$string['totalpointsgoal'] = 'Total point goal for the entire term';
