...
$string['sectiontypebottom'] = 'The last section of the course';
$string['sectiontypesorted'] = 'A separate section for each publisher/level';
$string['sectiontypespecific'] = 'The following specific section (select one)';