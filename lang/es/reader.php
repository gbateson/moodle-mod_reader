...
$string['anywhere'] = 'Cualquier sitio';
...
$string['book'] = 'libro';
$string['bookcovers'] = 'Mostrar forros de los libros';
...
$string['checkcheating'] = 'Medidas de seguridad';
...
$string['minpassgrade'] = 'Porcentaje correcto por haber indicado que el libro sea leido';
...
$string['stoplevel'] = 'Ningún promoción después del nivel';
...
$string['thislevel'] = 'Dar el próximo nivel, cuando alumno respondió más que correctos exámenes';
$string['timeleft'] = 'Tiempo Restante';
$string['to'] = 'a';
$string['totalpointsgoal'] = 'Objetivo total de puntos para el trimestre entero';
$string['uniqueip'] = 'Prohibir acceso para usuarios individuales';
...
$string['event_attempt_added'] = 'event_attempt_added';
$string['event_attempt_added_desc'] = 'The user with id "{$a->userid}" has attempt_added for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_attempt_deleted'] = 'event_attempt_deleted';
$string['event_attempt_deleted_desc'] = 'The user with id "{$a->userid}" has attempt_deleted for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_attempt_edited'] = 'event_attempt_edited';
$string['event_attempt_edited_desc'] = 'The user with id "{$a->userid}" has attempt_edited for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_attempt_submitted'] = 'event_attempt_submitted';
$string['event_attempt_submitted_desc'] = 'The user with id "{$a->userid}" has attempt_submitted for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_book_added'] = 'event_book_added';
$string['event_book_added_desc'] = 'The user with id "{$a->userid}" has book_added for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_book_deleted'] = 'event_book_deleted';
$string['event_book_deleted_desc'] = 'The user with id "{$a->userid}" has book_deleted for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_book_edited'] = 'event_book_edited';
$string['event_book_edited_desc'] = 'The user with id "{$a->userid}" has book_edited for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_books_downloaded'] = 'event_books_downloaded';
$string['event_books_downloaded_desc'] = 'The user with id "{$a->userid}" has books_downloaded for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_course_module_added_desc'] = 'The user with id "{$a->userid}" has course_module_added for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_course_module_deleted'] = 'event_course_module_deleted';
$string['event_course_module_deleted_desc'] = 'The user with id "{$a->userid}" has course_module_deleted for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_course_module_edited'] = 'event_course_module_edited';
$string['event_course_module_edited_desc'] = 'The user with id "{$a->userid}" has course_module_edited for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_course_module_instance_list_viewed'] = 'event_course_module_instance_list_viewed';
$string['event_course_module_instance_list_viewed_desc'] = 'The user with id "{$a->userid}" has course_module_instance_list_viewed for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_course_module_viewed'] = 'event_course_module_viewed';
$string['event_course_module_viewed_desc'] = 'The user with id "{$a->userid}" has course_module_viewed for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_course_modulea_dded'] = 'event_course_module_added';
$string['event_cron_run'] = 'event_cron _un';
$string['event_cron_run_desc'] = 'The user with id "{$a->userid}" has cron_run for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_downloads_viewed'] = 'event_downloads_viewed';
$string['event_downloads_viewed_desc'] = 'The user with id "{$a->userid}" has downloads_viewed for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_message_added'] = 'event_message_added';
$string['event_message_added_desc'] = 'The user with id "{$a->userid}" has message_added for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_message_deleted'] = 'event_message_deleted';
$string['event_message_deleted_desc'] = 'The user with id "{$a->userid}" has message_deleted for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_message_edited'] = 'event_message_edited';
$string['event_message_edited_desc'] = 'The user with id "{$a->userid}" has message_edited for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_quiz_added'] = 'event_quiz added';
$string['event_quiz_added_desc'] = 'The user with id "{$a->userid}" has quiz_added for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_quiz_delay_set'] = 'event_quiz_delay_set';
$string['event_quiz_delay_set_desc'] = 'The user with id "{$a->userid}" has quiz_delay_set for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_quiz_deleted'] = 'event_quiz_deleted';
$string['event_quiz_deleted_desc'] = 'The user with id "{$a->userid}" has quiz_deleted for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_quiz_edited'] = 'event_quiz_edited';
$string['event_quiz_edited_desc'] = 'The user with id "{$a->userid}" has quiz_edited for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_quiz_finished'] = 'event_quiz_finished';
$string['event_quiz_finished_desc'] = 'The user with id "{$a->userid}" has quiz_finished for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_quiz_selected'] = 'event_quiz_selected';
$string['event_quiz_selected_desc'] = 'The user with id "{$a->userid}" has quiz_selected for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_quiz_started'] = 'event_quiz_started';
$string['event_quiz_started_desc'] = 'The user with id "{$a->userid}" has quiz_started for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_report_bookdetailed_viewed'] = 'event_report bookdetailed viewed';
$string['event_report_bookdetailed_viewed_desc'] = 'The user with id "{$a->userid}" has report_bookdetailed_viewed for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_report_booksummary_viewed'] = 'event_report_booksummary_viewed';
$string['event_report_booksummary_viewed_desc'] = 'The user with id "{$a->userid}" has report_booksummary_viewed for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_report_groups_viewed'] = 'event_report_groups_viewed';
$string['event_report_groups_viewed_desc'] = 'The user with id "{$a->userid}" has report_groups_viewed for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_report_userdetailed_viewed'] = 'event_report_userdetailed_viewed';
$string['event_report_userdetailed_viewed_desc'] = 'The user with id "{$a->userid}" has report_userdetailed_viewed for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_report_usersummary_viewed'] = 'event_report_usersummary_viewed';
$string['event_report_usersummary_viewed_desc'] = 'The user with id "{$a->userid}" has report_usersummary_viewed for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_tool_run'] = 'event_tool_run';
$string['event_tool_run_desc'] = 'The user with id "{$a->userid}" has tool_run for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_user_goal_set'] = 'event_user_goal_set';
$string['event_user_goal_set_desc'] = 'The user with id "{$a->userid}" has user_goal_set for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_user_level_set'] = 'event_user_level_set';
$string['event_user_level_set_desc'] = 'The user with id "{$a->userid}" has user_level_set for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_users_exported'] = 'event_users_exported';
$string['event_users_exported_desc'] = 'The user with id "{$a->userid}" has users_exported for the reader with the course module id "{$a->contextinstanceid}"';
$string['event_users_imported'] = 'event_users_imported';
$string['event_users_imported_desc'] = 'The user with id "{$a->userid}" has users_imported for the reader with the course module id "{$a->contextinstanceid}"';
