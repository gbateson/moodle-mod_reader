...
//Function to delete dirs/files into temp/backup directory
    ...
    /**
     * backup_delete_old_dirs
     *
     * @uses $CFG
     * @param xxx $delete_from
     * @return xxx
     * @todo Finish documenting this function
     */
...
//Function to delete all the directory contents recursively
     ...
     *
     * @param xxx $dir
     * @param xxx $excludeddir (optional, default="")
     * @return xxx
     * @todo Finish documenting this function
     */
...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
     ...
     * @param xxx $from_file
     * @param xxx $to_file
     * @param xxx $log_clam (optional, default=false)
     * @return xxx
     * @todo Finish documenting this function
     */
...
//This function is used to insert records in the reader_backup_ids table
     ...
     * @param xxx $old_id
     * @param xxx $new_id
     * @param xxx $info (optional, default="")
     * @return xxx
     * @todo Finish documenting this function
     */
...
//This function is used to add slashes (and decode from UTF-8 if needed)
     ...
     *
     * @param xxx $data
     * @param xxx $addslashes (optional, default=true)
     * @return xxx
     * @todo Finish documenting this function
     */
...
//This function is used to check that every necessary function to
     ...
     *
     * @param xxx $justcheck (optional, default=false)
     * @return xxx
     * @todo Finish documenting this function
     */
...
//This function send n white characters to the browser and flush the
     ...
     * backup_flush
     *
     * @param xxx $n (optional, default=0)
     * @param xxx $time (optional, default=false)
     * @todo Finish documenting this function
     */
