...
//This function restores the quiz_question_instances
    ...
    /**
     * quiz_question_instances_restore_mods
     *
     * @uses $CFG
     * @param xxx $quiz_id
     * @param xxx $info
...
//This function restores the quiz_question_versions
    ...
    /**
     * quiz_question_versions_restore_mods
     *
     * @uses $CFG
     * @uses $USER
     * @param xxx $quiz_id
...
//This function makes all the necessary calls to xxxx_decode_content_links()
    ...
    /**
     * quiz_decode_content_links_caller
     *
     * @uses $CFG
     * @param xxx $restore
     * @return xxx
    ...
    function quiz_restore_logs($restore,$log) {
        ...
        case "preview":
            if ($log->cmid) {
                ...
                $mod = backup_getid($restore->backup_unique_code,$log->module,$log->info);
                if ($mod) {
                    $log->url = "quiz/attempt.php?id=".$log->cmid;
                    $log->info = $mod->new_id;
                    $status = true;
                }
            }
