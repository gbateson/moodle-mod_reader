...
// roles strings
$string['reader:managequizzes'] = 'Add course quizzes to reader quizzes';
$string['reader:addinstance'] = 'Add a new Reader activity';
$string['reader:viewbooks'] = 'Attempt readers';
$string['reader:manageusers'] = 'Award Extra Points';
$string['reader:managebooks'] = 'Change Reading Level or Length Factor';
$string['reader:manageusers'] = 'Change Student Levels and Promotion Criteria';
$string['reader:manageusers'] = 'Check logs for suspicious activity';
$string['reader:managequizzes'] = 'Create Cover Sets by Level & Publisher';
$string['reader:managequizzes'] = 'Create Cover Sets by Publisher & Level';
$string['reader:managequizzes'] = 'Delete quizzes';
$string['reader:manageusers'] = 'Delete reader attempts';
$string['reader:managequizzes'] = 'Download quizzes from the Reader Quiz Database';
$string['reader:manageusers'] = 'Forced time delay';
$string['reader:gradereadersmanually'] = 'Grade readers manually';
$string['reader:manageusers'] = 'Ignores time limit on readers';
$string['reader:addinstance'] = 'Manage';
$string['reader:addinstancereaders'] = 'Manage readers';
$string['reader:viewbooks'] = 'Preview readers';
$string['reader:viewreports'] = 'View reader reports';
$string['reader:managequizzes'] = 'Select quizzes to make available to students';
$string['reader:manageusers'] = 'Send Message';
$string['reader:manageusers'] = 'Set goal';
$string['reader:uploaddatanoquizzes'] = 'Download data for books that have no quizzes';
$string['reader:manageusers'] = 'User DB management';
$string['reader:manageusers'] = 'View and Delete Attempts';
$string['reader:viewreaderinformation'] = 'View reader information';
$string['reader:viewreaderreports'] = 'View reader reports';
$string['reader:manageusers'] = 'View student reader screens';
