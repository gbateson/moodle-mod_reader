...
/**
 * reader_user_filtering
 *
 * @copyright 2013 Gordon Bateson
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since     Moodle 2.0
 */
class reader_user_filtering extends user_filtering {
    ...
    function get_field($fieldname, $advanced)  {
        ...
        switch ($fieldname) {
            case 'group':
            case 'grouping':
                return new reader_filter_group($fieldname, $advanced, $default);
            case 'grade':
                $label = get_string('grade');
                return new reader_filter_grade($fieldname, $label, $advanced, $default);
            case 'timemodified':
                $label = get_string('time', 'quiz');
                return new user_filter_date($fieldname, $label, $advanced, $fieldname);
            case 'status':
                return new reader_filter_status($fieldname, $advanced, $default);
            case 'duration':
                $label = get_string('duration', 'reader');
                return new reader_filter_duration($fieldname, $label, $advanced, $default);
            case 'penalties':
                $label = get_string('penalties', 'reader');
                return new reader_filter_number($fieldname, $label, $advanced, $default);
            case 'score':
 ...
 * @since     Moodle 2.0
 */
class reader_filter_group extends user_filter_select {
    /**
     * Constructor
...
/**
 * reader_filter_status
 *
 * @copyright 2013 Gordon Bateson
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since     Moodle 2.0
 */
class reader_filter_status extends user_filter_select {
    /**
     * Constructor
     *
     * @param string $name the name of the filter instance
...
/**
 * reader_filter_number
 *
 * @copyright 2013 Gordon Bateson
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since     Moodle 2.0
 */
class reader_filter_number extends user_filter_select {
    /**
     * Constructor
     *
     * @param string $name the name of the filter instance
 ...
 * @since     Moodle 2.0
 */
class reader_filter_grade extends reader_filter_number {
...
/**
 * reader_filter_duration
 *
 * @copyright 2013 Gordon Bateson
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @since     Moodle 2.0
 */
class reader_filter_duration extends reader_filter_number {
